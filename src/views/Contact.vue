  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "De La Cruz's Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe"
      },
      { charset: "utf-8" },
      ...
      },
      {
        ...
        content:
          "De La Cruz's Contact Bogota Colombia Freelance Get in Touch ContactMe"
      }
    ]
  },
