  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "De La Cruz's Web Portfolio Vue Vue.js Nuxt Nuxt.js HTML CSS Vuetify Axios GraphQL JavaScript Web Developer Front-End Frontend Designer App Responsive"
      },
      { charset: "utf-8" },
    ...
    return {
      ...
      projects: [
        ...
        },
        {
          dialog: false,
          title: "This Site",
          git: "https://github.com/EldinZaimovic/delacruz",
