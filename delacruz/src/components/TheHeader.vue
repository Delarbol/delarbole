    ...
    <div>
      <v-navigation-drawer v-model="drawer" absolute temporary app width="150" height="340">
        <v-list class="pt-4">
          ...
          <v-list-tile disabled active-class="green--text" to="/services">
            <v-list-tile-content>
              <v-list-tile-title>SERVICIOS</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
          <v-list-tile disabled active-class="green--text" to="/portfolio">
            <v-list-tile-content>
              <v-list-tile-title>PORTAFOLIO</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
          <v-list-tile disabled active-class="green--text" to="/blog">
            <v-list-tile-content>
              <v-list-tile-title>VLOG</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
      ...
      <v-toolbar flat dense color="transparent" scroll-off-screen>
        ...
        <v-toolbar-title class="headline">
          <span class="font-weight-light">Camilo</span>
          <span class="green--text">DeLaCruz</span>
        </v-toolbar-title>
        <v-spacer></v-spacer>
        ...
        <v-toolbar-items class="hidden-sm-and-down">
          ...
          <v-btn disabled flat to="/services" active-class="green--text headline">Servicios</v-btn>
          <v-btn disabled flat to="/portfolio" active-class="green--text headline">Portafolio</v-btn>
          <v-btn disabled flat to="/blog" active-class="green--text headline">Vlog</v-btn>
          <v-btn flat to="/contact" active-class="green--text headline">Contacto</v-btn>
